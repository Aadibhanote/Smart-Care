...
//         type:Object,
//         required:true,
//         default:{City : "XXXX" , Palace: "XXXXXX"}
//     },
//     gender:{
//         type:String,
//         required:true
...
//     const valid = await  bcrypt.compare(passwordByUser ,password);
//     if(!valid) return res.status(404).json({Error : "Invalid Credential!!"});
//     return valid;
// }
...
const userSchema = new mongoose.Schema(
  {
    ...
    DOB: { type: String, default: "XX/XX/XXXX" },
...
// module.exports = UserModel;
const UserModel = mongoose.model("User", userSchema);
module.exports = { UserModel }; // ✅ named export
